module Day10.CathodeRayTubeSpec (spec) where
...
spec :: Spec
spec = do
  describe "Find the signal strength during the 20th, 60th, 100th, 140th, 180th, and 220th cycles. What is the sum of these six signal strengths?" $ do
    it "The sum of these signal strengths is 13140." $ do
      signalStrengthSum exampleInput `shouldBe` 13140
